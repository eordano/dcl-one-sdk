...
enum Command {
    ...
    Deploy {
        ...
        #[arg(
            long,
            hide = true,
            help = "Alias of --target-server for a content-server URL"
        )]
    ...
    Unpublish {
        ...
        #[arg(
            ...
            long = "target-server",
            alias = "target",
            help = "Catalyst domain or content-server URL to act on; DCL_ONE_SDK_TARGET_SERVER from the environment otherwise"
        )]
        target: Option<String>,
        #[arg(
            long,
...
enum WorldSettingsCommand {
    ...
    Get {
        ...
        #[arg(
            ...
            help = "Worlds server to read from; DCL_ONE_SDK_TARGET_SERVER from the environment otherwise"
        )]
        target_content: Option<String>,
    },
...
struct SignedWriteArgs {
    #[arg(
        long = "target-server",
        alias = "target-content",
        help = "Worlds server to publish this signed request to; DCL_ONE_SDK_TARGET_SERVER from the environment otherwise"
    )]
    target_content: Option<String>,
    #[arg(long)]
    sign_key: Option<PathBuf>,
